...
const MOVEMENT_PATTERNS = [
  ...
  'gait',
  'spinal_flexion',
  'anti_extension', // W2.4 — core exercises (migration 040)
] as const;
...
export const ExerciseSeedSchema = z
  ...
  .refine((e) => e.muscle_contributions[e.primary_muscle] === 1.0, {
    message: 'primary_muscle must have contribution = 1.0',
    path: ['muscle_contributions'],
  });
