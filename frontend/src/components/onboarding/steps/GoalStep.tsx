  ...
  return (
    <div style={{ fontFamily: FONTS.ui }}>
      <p style={{ color: TOKENS.textDim, fontSize: 14, lineHeight: 1.6, margin: '0 0 16px' }}>
        Your goal sets where the auto-ramp starts — closer to <Term k="MEV" /> for a cut,
        toward <Term k="MAV" /> for a bulk.
      </p>
      <div role="radiogroup" aria-label="Training goal" style={{ display: 'grid', gap: 10 }}>
        {GOALS.map((g) => {
          ...
          return (
            ...
            >
              <div style={{ fontFamily: FONTS.mono, fontSize: 11, letterSpacing: 1.4, color: TOKENS.accent, marginBottom: 4 }}>
                {g.title}
              </div>
